	...
	$('#gd-nav-search-next').on('click', function(e){
		...
		$('.gd-highlight').each(function(e){
			if(count == search_position){
				...
				if(search_position >= getSignatureSearchMatches()){
		...
		setSearchMatchCount(search_position, getSignatureSearchMatches());
	});
...
function highlightSearch(text) {
    ...
    if(text.length > 1){
		...
		var totalSearchMatches = getSignatureSearchMatches();
...
*/
function getSignatureSearchMatches(){
