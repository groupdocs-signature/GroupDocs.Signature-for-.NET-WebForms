    ...
    public class SignatureApiController : ApiController
    {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(url))
                {
                    if (HttpContext.Current.Request.Files.AllKeys != null)
                    {
                        ...
                        if (httpPostedFile != null)
                        {
                            ...
                            {
                                fileSavePath = GroupDocs.Signature.WebForms.Products.Common.Resources.Resources.GetFreeFileName(fileSavePath, httpPostedFile.FileName);
                            }
                ...
                else
                {
                    using (WebClient client = new WebClient())
                    {
                        ...
                        {
                            fileSavePath = GroupDocs.Signature.WebForms.Products.Common.Resources.Resources.GetFreeFileName(fileSavePath, fileName);
                        }
        ...
        public HttpResponseMessage SaveImage(SignaturePostedDataEntity postedData)
        {
            try
            {
                ...
                {
                    imageName = Path.GetFileName(GroupDocs.Signature.WebForms.Products.Common.Resources.Resources.GetFreeFileName(DirectoryUtils.DataDirectory.ImageDirectory.Path, imageName));
